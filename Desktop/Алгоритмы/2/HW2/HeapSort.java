...
class Main {
    ...
    // Рекурсивный алгоритм heapify-down. Узел с индексом `i` и два его прямых
    ...
    public static void heapsort(int[] A) {
        ...
        // Build-heap: вызывать heapify, начиная с последнего внутреннего узел до
        // корневого узла
        int i = (n - 2) / 2;
        while (i >= 0) {
            heapify(A, i--, n);
